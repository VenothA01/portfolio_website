...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        Made with
        <div className="text-red-500 px-2 text-2xl">&#128077</div>
        by Venoth A
      </div>
    </div>
  );
